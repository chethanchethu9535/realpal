  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <Link
          className="bg-yellow-500 text-white p-3 rounded-lg uppercase text-center hover:opacity-65"
          to={"/createlisting"}
        >
          Create Listing
        </Link>
      ...
      <button
        ...
        className="text-green-800 w-full font-bold"
      >
        Show Listing
      </button>
      ...
      {userListings && userListings.length > 0 && (
        <div className="flex flex-col gap-4">
          ...
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className="border rounded-lg p-3 flex justify-between item-center gap-4"
            >
              ...
              <div className=" flex flex-col items-center">
                <button
                  ...
                  className="text-blue-900 uppercase"
                >
                  Delete
                </button>
