  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-8'>
            ...
            <button disabled={loading || uploading } className='p-3 bg-violet-600 text-white rounded-lg uppercase hover:opacity-80 disabled:opacity-80'>{loading ? 'creating....' : 'create listing'}</button>
